...
function startClock() {
    ...
    let secDeg = seconds * 6 + minutes * 360;
    let minDeg = minutes * 6 + seconds / 12;
    let hourDeg = hours * 30 + minutes / 12 * 6;
...
},{"./style.css":"bhJkM"}],"bhJkM":[function() {},{}]},["bcmUh","8ZNvh"], "8ZNvh", "parcelRequire330c")
